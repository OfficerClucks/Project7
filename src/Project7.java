...
public class Project7 
{
	...
	public static String scramble(String word){// Construct StringBuilder objects used to scramble the word. The 
	 ...
	 public static int guess(String scrambledWord, String word, Scanner keyboard) {
			int numGuesses;
	 ...
	 public static int point(String word, int numGuesses) {
	...
	int numGuesses = guess(scrambledWord, word, keyboard);	
			int pointsEarned = point(word, numGuesses);
		int wordPoints = word.length() - 1;
